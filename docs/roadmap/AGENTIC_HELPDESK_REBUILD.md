...
- **5.1 Capability registry.** New `backend/app/services/agents/registry.py` maps `domain → AgentSpec{name, subgraph_factory, tools, enabled_flag}`. Register `helpdesk` only.
